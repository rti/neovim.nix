...
let
  vimThemeLua = pkgs.writeTextDir "lua/colors/rti.lua" /* lua */ ''
    ...
    function M._setup()
      ...
      hi("@org.headline.level2", { fg = "${config.theme.foreground}", bg = "${config.theme.backgroundMagenta}", attr = "bold" })
      hi("@org.headline.level3", { fg = "${config.theme.foreground}", bg = "${config.theme.backgroundGreen}", attr = "bold" })
      hi("@org.headline.level4", { fg = "${config.theme.foreground}", bg = "${config.theme.backgroundYellow}", attr = "bold" })
