...
let
  vimThemeLua = pkgs.writeTextDir "lua/colors/rti.lua" /* lua */ ''
    ...
    function M._setup()
      ...
      hi("diffFile", { fg = "${config.theme.foreground}", bg = "${config.theme.background4}", attr = "bold" })
      ...
      hi("GitSignsAdd", { fg = "${config.theme.backgroundGreen}" })
      hi("GitSignsChange", { fg = "${config.theme.backgroundYellow}" })
      hi("GitSignsDelete", { fg = "${config.theme.backgroundRed}" })
      ...
      hi("RenderMarkdownH4", { fg = "${config.theme.foreground}", bg = "${config.theme.backgroundBlue}", attr = "bold" })
      hi("RenderMarkdownH5", { fg = "${config.theme.foreground}", bg = "${config.theme.backgroundBlue}", attr = "bold" })
      hi("RenderMarkdownH6", { fg = "${config.theme.foreground}", bg = "${config.theme.backgroundBlue}", attr = "bold" })
      hi("RenderMarkdownH1Bg", { fg = "${config.theme.foreground}", bg = "${config.theme.backgroundBlue}", attr = "bold" })
      hi("RenderMarkdownH2Bg", { fg = "${config.theme.foreground}", bg = "${config.theme.backgroundBlue}", attr = "bold" })
      hi("RenderMarkdownH3Bg", { fg = "${config.theme.foreground}", bg = "${config.theme.backgroundBlue}", attr = "bold" })
      hi("RenderMarkdownH4Bg", { fg = "${config.theme.foreground}", bg = "${config.theme.backgroundBlue}", attr = "bold" })
      hi("RenderMarkdownH5Bg", { fg = "${config.theme.foreground}", bg = "${config.theme.backgroundBlue}", attr = "bold" })
      hi("RenderMarkdownH6Bg", { fg = "${config.theme.foreground}", bg = "${config.theme.backgroundBlue}", attr = "bold" })
      hi("RenderMarkdownCode", { bg = "${config.theme.background2}" })
      hi("RenderMarkdownCodeInfo", { fg = "${config.theme.foreground4}", bg = "${config.theme.background3}" })
      hi("RenderMarkdownCodeBorder", { fg = "${config.theme.foreground4}", bg = "${config.theme.background3}" })
      hi("RenderMarkdownCodeFallback", { fg = "${config.theme.foreground}", bg = "${config.theme.background2}" })
      hi("RenderMarkdownCodeInline", { fg = "${config.theme.foreground}", bg = "${config.theme.background2}" })
      hi("RenderMarkdownQuote", { fg = "${config.theme.background4}" })
      hi("RenderMarkdownQuote1", "RenderMarkdownQuote")
      hi("RenderMarkdownQuote2", "RenderMarkdownQuote")
      hi("RenderMarkdownQuote3", "RenderMarkdownQuote")
      hi("RenderMarkdownQuote4", "RenderMarkdownQuote")
      hi("RenderMarkdownQuote5", "RenderMarkdownQuote")
      hi("RenderMarkdownQuote6", "RenderMarkdownQuote")
      hi("RenderMarkdownInlineHighlight", "Normal")
      hi("RenderMarkdownBullet", { fg = "${config.theme.foreground2}" })
      hi("RenderMarkdownDash", { fg = "${config.theme.background4}" })
      hi("RenderMarkdownSign", { fg = "${config.theme.foreground4}" })
      hi("RenderMarkdownMath", "Normal")
      hi("RenderMarkdownIndent", "Normal")
      hi("RenderMarkdownHtmlComment", "Normal")
      hi("RenderMarkdownLink", { fg = "${config.theme.foregroundBlue}" })
      hi("RenderMarkdownWikiLink", { fg = "${config.theme.foregroundBlue}" })
      hi("RenderMarkdownUnchecked", "Normal")
      hi("RenderMarkdownChecked", "Normal")
      hi("RenderMarkdownTodo", "Normal")
      hi("RenderMarkdownTableHead", { fg = "${config.theme.background4}" })
      hi("RenderMarkdownTableRow", "RenderMarkdownTableHead")
      hi("RenderMarkdownTableFill", "RenderMarkdownTableHead")
      hi("RenderMarkdownSuccess", "Normal")
      hi("RenderMarkdownInfo", "Normal")
      hi("RenderMarkdownHint", "Normal")
      hi("RenderMarkdownWarn", "Normal")
      ...
      hi("@org.headline.level1", { fg = "${config.theme.foreground}", bg = "${config.theme.backgroundCyan}", attr = "bold" })
      hi("@org.headline.level2", { fg = "${config.theme.foreground}", bg = "${config.theme.backgroundYellow}", attr = "bold" })
      hi("@org.headline.level3", { fg = "${config.theme.foreground}", bg = "${config.theme.backgroundMagenta}", attr = "bold" })
      hi("@org.headline.level4", { fg = "${config.theme.foreground}", bg = "${config.theme.backgroundGreen}", attr = "bold" })
      hi("@org.headline.level5", { fg = "${config.theme.foreground}", bg = "${config.theme.backgroundRed}", attr = "bold" })
      ...
      hi("NeogitBranch", { fg = "${config.theme.foregroundBlue}" })
      hi("NeogitBranchHead", { fg = "${config.theme.foregroundMagenta}", attr = "bold" })
      hi("NeogitRemote", { fg = "${config.theme.foregroundCyan}" })
      hi("NeogitObjectId", { fg = "${config.theme.foreground3}" })
      hi("NeogitStash", { fg = "${config.theme.foregroundYellow}" })
      hi("NeogitFold", "Folded")
      hi("NeogitFoldColumn", "FoldColumn")
      hi("NeogitSignColumn", "SignColumn")
      hi("NeogitRebaseDone", { fg = "${config.theme.foregroundGreen}" })
      hi("NeogitTagName", { fg = "${config.theme.foregroundCyan}" })
      hi("NeogitTagDistance", { fg = "${config.theme.foreground3}" })
      hi("NeogitStatusHEAD", { fg = "${config.theme.foregroundBlue}", attr = "bold" })
      hi("NeogitSectionHeader", "Title")
      hi("NeogitUnpushedTo", "NeogitSectionHeader")
      hi("NeogitUnmergedInto", "NeogitSectionHeader")
      hi("NeogitUnpulledFrom", "NeogitSectionHeader")
      hi("NeogitUntrackedfiles", "NeogitSectionHeader")
      hi("NeogitUnstagedchanges", "NeogitSectionHeader")
      hi("NeogitUnmergedchanges", "NeogitSectionHeader")
      hi("NeogitUnpushedchanges", "NeogitSectionHeader")
      hi("NeogitUnpulledchanges", "NeogitSectionHeader")
      hi("NeogitRecentcommits", "NeogitSectionHeader")
      hi("NeogitStagedchanges", "NeogitSectionHeader")
      hi("NeogitStashes", "NeogitSectionHeader")
      hi("NeogitRebasing", "NeogitSectionHeader")
      hi("NeogitReverting", "NeogitSectionHeader")
      hi("NeogitPicking", "NeogitSectionHeader")
      hi("NeogitMerging", "NeogitSectionHeader")
      hi("NeogitBisecting", "NeogitSectionHeader")
      hi("NeogitSectionHeaderCount", { fg = "${config.theme.foreground3}" })
      hi("NeogitChangeModified", { fg = "${config.theme.foregroundYellow}" })
      hi("NeogitChangeAdded", { fg = "${config.theme.foregroundGreen}" })
      hi("NeogitChangeDeleted", { fg = "${config.theme.foregroundRed}" })
      hi("NeogitChangeRenamed", { fg = "${config.theme.foregroundBlue}" })
      hi("NeogitChangeUpdated", { fg = "${config.theme.foregroundBlue}" })
      hi("NeogitChangeCopied", { fg = "${config.theme.foregroundGreen}" })
      hi("NeogitChangeNewFile", { fg = "${config.theme.foregroundGreen}" })
      hi("NeogitChangeUnmerged", { fg = "${config.theme.foregroundRed}" })
      hi("NeogitHunkHeader", { fg = "${config.theme.foregroundMagenta}" })
      hi("NeogitDiffContext", "Normal")
      hi("NeogitDiffAdd", "DiffAdd")
      hi("NeogitDiffDelete", "DiffDelete")
      hi("NeogitDiffHeader", "diffFile")
      hi("NeogitActiveItem", "CursorLine")
      hi("NeogitHunkHeaderHighlight", "NeogitHunkHeader")
      hi("NeogitDiffContextHighlight", "NeogitDiffContext")
      hi("NeogitDiffAddHighlight", "NeogitDiffAdd")
      hi("NeogitDiffDeleteHighlight", "NeogitDiffDelete")
      hi("NeogitDiffHeaderHighlight", "NeogitDiffHeader")
      hi("NeogitHunkHeaderCursor", "NeogitHunkHeader")
      hi("NeogitDiffContextCursor", "NeogitDiffContext")
      hi("NeogitDiffAddCursor", "NeogitDiffAdd")
      hi("NeogitDiffDeleteCursor", "NeogitDiffDelete")
      hi("NeogitDiffHeaderCursor", "NeogitDiffHeader")
      hi("NeogitFilePath", "Directory")
      hi("NeogitCommitViewHeader", "Title")
      hi("NeogitGraphAuthor", { fg = "${config.theme.foregroundBlue}" })
      hi("NeogitGraphBlack", { fg = "${config.theme.background}" })
      hi("NeogitGraphBoldBlack", { fg = "${config.theme.foreground3}", attr = "bold" })
      hi("NeogitGraphRed", { fg = "${config.theme.foregroundRed}" })
      hi("NeogitGraphBoldRed", { fg = "${config.theme.brightRed}", attr = "bold" })
      hi("NeogitGraphGreen", { fg = "${config.theme.foregroundGreen}" })
      hi("NeogitGraphBoldGreen", { fg = "${config.theme.brightGreen}", attr = "bold" })
      hi("NeogitGraphYellow", { fg = "${config.theme.foregroundYellow}" })
      hi("NeogitGraphBoldYellow", { fg = "${config.theme.brightYellow}", attr = "bold" })
      hi("NeogitGraphBlue", { fg = "${config.theme.foregroundBlue}" })
      hi("NeogitGraphBoldBlue", { fg = "${config.theme.brightBlue}", attr = "bold" })
      hi("NeogitGraphPurple", { fg = "${config.theme.foregroundMagenta}" })
      hi("NeogitGraphBoldPurple", { fg = "${config.theme.brightMagenta}", attr = "bold" })
      hi("NeogitGraphCyan", { fg = "${config.theme.foregroundCyan}" })
      hi("NeogitGraphBoldCyan", { fg = "${config.theme.brightCyan}", attr = "bold" })
      hi("NeogitGraphWhite", { fg = "${config.theme.foreground}" })
      hi("NeogitGraphBoldWhite", { fg = "${config.theme.foreground3}", attr = "bold" })
      hi("NeogitGraphGray", { fg = "${config.theme.foreground3}" })
      hi("NeogitGraphBoldGray", { fg = "${config.theme.foreground}", attr = "bold" })
      hi("NeogitGraphOrange", { fg = "${config.theme.foregroundYellow}" })
      hi("NeogitSignatureGood", { fg = "${config.theme.foregroundGreen}" })
      hi("NeogitSignatureBad", { fg = "${config.theme.foregroundRed}" })
      hi("NeogitSignatureMissing", { fg = "${config.theme.foregroundYellow}" })
      hi("NeogitSignatureNone", { fg = "${config.theme.foreground4}" })
      hi("NeogitSignatureGoodUnknown", { fg = "${config.theme.foregroundYellow}" })
      hi("NeogitSignatureGoodExpired", { fg = "${config.theme.foregroundYellow}" })
      hi("NeogitSignatureGoodExpiredKey", { fg = "${config.theme.foregroundYellow}" })
      hi("NeogitSignatureGoodRevokedKey", { fg = "${config.theme.foregroundRed}" })
      hi("NeogitPopupSectionTitle", "Title")
      hi("NeogitPopupBranchName", { fg = "${config.theme.foregroundBlue}", attr = "bold" })
      hi("NeogitPopupBold", "Bold")
      hi("NeogitPopupSwitchKey", { fg = "${config.theme.foregroundGreen}" })
      hi("NeogitPopupSwitchEnabled", { fg = "${config.theme.foregroundGreen}" })
      hi("NeogitPopupSwitchDisabled", { fg = "${config.theme.foregroundRed}" })
      hi("NeogitPopupOptionKey", "NeogitPopupSwitchKey")
      hi("NeogitPopupOptionEnabled", "NeogitPopupSwitchEnabled")
      hi("NeogitPopupOptionDisabled", "NeogitPopupSwitchDisabled")
      hi("NeogitPopupConfigKey", "NeogitPopupSwitchKey")
      hi("NeogitPopupConfigEnabled", "NeogitPopupSwitchEnabled")
      hi("NeogitPopupConfigDisabled", "NeogitPopupSwitchDisabled")
      hi("NeogitPopupActionKey", { fg = "${config.theme.foregroundCyan}" })
      hi("NeogitPopupActionDisabled", { fg = "${config.theme.foreground4}" })
      hi("NeogitCommandText", "Normal")
      hi("NeogitCommandTime", { fg = "${config.theme.foreground3}" })
      hi("NeogitCommandCodeNormal", { fg = "${config.theme.foregroundGreen}" })
