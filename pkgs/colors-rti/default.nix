...
let
  vimThemeLua = pkgs.writeTextDir "lua/colors/rti.lua" /* lua */ ''
    ...
    function M._setup()
      ...
      hi("RenderMarkdownCode", { bg = "${config.theme.background3}" })
      hi("RenderMarkdownCodeInfo", { fg = "${config.theme.foreground3}", bg = "${config.theme.background3}" })
      hi("RenderMarkdownCodeBorder", { fg = "${config.theme.foreground3}", bg = "${config.theme.background3}" })
      hi("RenderMarkdownCodeFallback", { fg = "${config.theme.foreground}", bg = "${config.theme.background3}" })
      hi("RenderMarkdownCodeInline", { fg = "${config.theme.foreground}", bg = "${config.theme.background3}" })
