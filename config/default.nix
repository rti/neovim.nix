  ...
  config = {
    ...
    extraConfigLua = ''
      ...
      local function setup_autohide_cursorline()
        ...
        autocmd!
        autocmd WinEnter,BufEnter * if &filetype != 'NvimTree' && &filetype != 'dashboard' && &filetype != 'DiffviewFiles' | setlocal cursorline | endif
        autocmd WinLeave,BufLeave * if &filetype != 'NvimTree' && &filetype != 'dashboard' && &filetype != 'DiffviewFiles' | setlocal nocursorline | endif
        augroup END
        ]], false)
      end
